    ...
    public class DepartmentSqlDao : IDepartmentDao
    {
        ...
        public Department GetDepartment(int departmentId)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                if(reader.Read())
                {
                    department = CreateDepartmentIdFromReader(reader);
                }
            }
            return department;
        }
        ...
        public IList<Department> GetAllDepartments()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                while(reader.Read())
                {
                    Department department = CreateDepartmentIdFromReader(reader);
        ...
        private Department CreateDepartmentIdFromReader(SqlDataReader reader)
        {
