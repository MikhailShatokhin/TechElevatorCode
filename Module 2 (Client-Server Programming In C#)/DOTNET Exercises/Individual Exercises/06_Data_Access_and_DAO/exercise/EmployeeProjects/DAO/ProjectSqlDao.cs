...
namespace EmployeeProjects.DAO
{
    public class ProjectSqlDao : IProjectDao
    {
        ...
        public Project GetProject(int projectId)
        {
            ...
            return project;
            //return project(0, CreateProjectFromReader, DateTime.Now,DateTime.Now.AddDays(1));
        ...
        public IList<Project> GetAllProjects()
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("SELECT project_id, name, from_date, to_date FROM project;", conn);
        ...
        public void DeleteProject(int projectId)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd2 = new SqlCommand("DELETE FROM project WHERE project_id = @project_id;", conn);
                cmd.Parameters.AddWithValue("@project_id", projectId);
