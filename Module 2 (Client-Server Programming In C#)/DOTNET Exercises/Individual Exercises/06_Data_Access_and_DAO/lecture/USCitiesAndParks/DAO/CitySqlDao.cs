    ...
    public class CitySqlDao : ICityDao
    {
        ...
        public void UpdateCity(City city)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("UPDATE city SET city_name = @city_name, " + 
                    "state_abbreviation = @state_abbreviation, population = @population, " + 
                    "area = @area WHERE city_id = @city_id;", conn);
